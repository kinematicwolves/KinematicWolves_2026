...
public class LaunchFromPose extends Command {
    ...
    public LaunchFromPose(CommandSwerveDrivetrain drivetrainSubsystem, Launcher launcherSubsystem, Indexer indexerSubsystem, double rollerSpeed, double kickerSpeed) {
    ...
    public void execute() {
        ...
        if (this.launcherSubsystem.flywheelAtSpeed() && this.launcherSubsystem.hoodIsAtSetpoint()) {
            this.indexerSubsystem.setRollerPercent(this.rollerSpeed);
            this.indexerSubsystem.setKickerPercent(this.kickerSpeed);
        }
