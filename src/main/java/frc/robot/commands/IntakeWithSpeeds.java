...
public class IntakeWithSpeeds extends Command {
    ...
    public IntakeWithSpeeds(Intake intakeSubsystem, Indexer indexerSubystem, double intakeSeed, double indexerSpeed) {
        // 2) pass all values to the internal variables
        this.intakeSubsystem = intakeSubsystem;
        this.indexerSubsystem = indexerSubystem;
        this.intakeSpeed = intakeSeed;
    ...
    public void initialize() {
        this.intakeSubsystem.setRollerSpeed(this.intakeSpeed);
        this.indexerSubsystem.setRollerSpeed(this.indexerSpeed);
    }
    ...
    public void end(boolean interrupted) {
        this.intakeSubsystem.setRollerSpeed(0);
