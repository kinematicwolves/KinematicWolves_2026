...
public class Constants {
    public static class LauncherProfile {
        ...
        public static final double launcherTolerance = 5; // rotations/s
    ...
    public static class IntakeProfile {
        ...
        public static final double retractPrecent = -0.75; // percent
        public static final double holdPercent     = 0.5;
    }
